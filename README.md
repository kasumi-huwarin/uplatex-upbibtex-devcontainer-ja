...
```bash
# HTTPS
git clone https://github.com/kouta-ochiai/uplatex-upbibtex-devcontainer-ja.git
cd uplatex-upbibtex-devcontainer-ja
```
```bash
# SSH（推奨）
git clone git@github.com:kouta-ochiai/uplatex-upbibtex-devcontainer-ja.git
cd uplatex-upbibtex-devcontainer-ja
```
